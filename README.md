...
Build Dependencies:
- base-devel mingw-w64-gcc mingw-w64-crt mingw-w64-headers mtools dosfstools parted qemu-full clang llvm gnu-efi nasm gdb python cpio

GDB:
- `make debug` launches Qemu and GDB 
- Available debug extetnion commands:
    - `twistedos-help`
    - `twistedos-processes`
