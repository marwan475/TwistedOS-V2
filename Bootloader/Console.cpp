...
Console::Console(EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL *ConOut,
...
void Console::Reset() { ConsoleOut->Reset(ConsoleOut, false); }

void Console::ClearConsole() { ConsoleOut->ClearScreen(ConsoleOut); }
...
void Console::SetTextMode(int mode) { ConsoleOut->SetMode(ConsoleOut, mode); }
...
EFI_GRAPHICS_OUTPUT_PROTOCOL_MODE Console::GetGopMode() { return *Gop->Mode; }
