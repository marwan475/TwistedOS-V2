...
$(KERNEL): Kernel/kernel.cpp Kernel/Testing/KernelSelfTests.cpp Kernel/Layers/Dispatcher.cpp Kernel/Layers/Resource/ResourceLayer.cpp Kernel/Layers/Resource/FrameBuffer.cpp Kernel/Layers/Resource/TTY.cpp Kernel/Layers/Resource/Keyboard.cpp Kernel/Layers/Resource/KernelHeapManager.cpp Kernel/Layers/Resource/RamFileSystemManager.cpp Kernel/Layers/Resource/VirtualAddressSpace.cpp Kernel/Layers/Resource/DeviceManager.cpp Kernel/Layers/Resource/Drivers/IDEController.cpp Kernel/Layers/Logic/ELFManager.cpp Kernel/Layers/Logic/LogicLayer.cpp Kernel/Layers/Logic/ProcessManager.cpp Kernel/Layers/Logic/Scheduler.cpp Kernel/Layers/Logic/SynchronizationManager.cpp Kernel/Layers/Logic/VirtualFileSystem.cpp Kernel/Layers/Translation/TranslationLayer.cpp Kernel/Layers/Translation/POSIX_SystemCalls.cpp Kernel/Memory/KernelHeapAllocations.cpp Kernel/Memory/PhysicalMemoryManager.cpp Kernel/Memory/VirtualMemoryManager.cpp Kernel/Logging/FrameBufferConsole.cpp Kernel/Arch/x86.cpp Kernel/Arch/Interrupts.asm Kernel/Arch/task.asm Kernel/Arch/syscall.asm utils/printf.cpp utils/CommonUtils.cpp Kernel/linker.ld
	...
	$(KERNEL_LD) $(KERNEL_LDFLAGS) $(BUILD)kernel.o $(BUILD)kernel_self_tests.o $(BUILD)dispatcher.o $(BUILD)resource_layer.o $(BUILD)frame_buffer.o $(BUILD)tty.o $(BUILD)keyboard.o $(BUILD)kernel_heap_manager.o $(BUILD)ram_file_system_manager.o $(BUILD)virtual_address_space.o $(BUILD)device_manager.o $(BUILD)ide_controller.o $(BUILD)elf_manager.o $(BUILD)logic_layer.o $(BUILD)process_manager.o $(BUILD)scheduler.o $(BUILD)synchronization_manager.o $(BUILD)virtual_file_system.o $(BUILD)translation_layer.o $(BUILD)posix_system_calls.o $(BUILD)kernel_heap_allocations.o $(BUILD)physical_memory_manager.o $(BUILD)virtual_memory_manager.o $(BUILD)framebuffer_console.o $(BUILD)x86.o $(BUILD)interrupts.o $(BUILD)task_switch.o $(BUILD)syscall.o $(BUILD)printf.o $(BUILD)common_utils.o -o $(BUILD)kernel.elf
