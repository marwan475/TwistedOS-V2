...
$(KERNEL): Kernel/kernel.cpp Kernel/Testing/KernelSelfTests.cpp Kernel/Layers/Dispatcher.cpp Kernel/Layers/Resource/ResourceLayer.cpp Kernel/Layers/Resource/FrameBuffer.cpp Kernel/Layers/Resource/TTY.cpp Kernel/Layers/Resource/Keyboard.cpp Kernel/Layers/Resource/Mouse.cpp Kernel/Layers/Resource/KernelHeapManager.cpp Kernel/Layers/Resource/RamFileSystemManager.cpp Kernel/Layers/Resource/VirtualAddressSpace.cpp Kernel/Layers/Resource/DeviceManager.cpp Kernel/Layers/Resource/EventDeviceManager.cpp Kernel/Layers/Resource/PartitionManager.cpp Kernel/Layers/Resource/ExtendedFileSystemManager.cpp Kernel/Layers/Resource/Drivers/IDEController.cpp Kernel/Layers/Resource/Drivers/VirtioRandom.cpp Kernel/Layers/Logic/ELFManager.cpp Kernel/Layers/Logic/InterProcessComunicationManager.cpp Kernel/Layers/Logic/LogicLayer.cpp Kernel/Layers/Logic/ProcessManager.cpp Kernel/Layers/Logic/Scheduler.cpp Kernel/Layers/Logic/SynchronizationManager.cpp Kernel/Layers/Logic/VirtualFileSystem.cpp Kernel/Layers/Translation/TranslationLayer.cpp Kernel/Layers/Translation/POSIX_SystemCalls.cpp Kernel/Memory/KernelHeapAllocations.cpp Kernel/Memory/PhysicalMemoryManager.cpp Kernel/Memory/VirtualMemoryManager.cpp Kernel/Logging/FrameBufferConsole.cpp Kernel/Arch/x86.cpp Kernel/Arch/Interrupts.asm Kernel/Arch/task.asm Kernel/Arch/syscall.asm utils/printf.cpp utils/CommonUtils.cpp Kernel/linker.ld
	...
	$(KERNEL_CC) $(KERNEL_CFLAGS) -I./Kernel -I./Bootloader -I./utils -c Kernel/Layers/Resource/Mouse.cpp -o $(BUILD)mouse.o
	...
	$(KERNEL_CC) $(KERNEL_CFLAGS) -I./Kernel -I./Bootloader -I./utils -c Kernel/Layers/Resource/EventDeviceManager.cpp -o $(BUILD)event_device_manager.o
	...
	$(KERNEL_CC) $(KERNEL_CFLAGS) -I./Kernel -I./Bootloader -I./utils -c Kernel/Layers/Resource/Drivers/VirtioRandom.cpp -o $(BUILD)virtio_random.o
