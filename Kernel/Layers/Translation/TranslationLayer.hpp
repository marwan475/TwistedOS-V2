...
public:
    ...
    int64_t HandleFutexSystemCall(int* UserAddress, int64_t Operation, int64_t Value, const void* Timeout, int* UserAddress2, int64_t Value3);
    ...
    int64_t HandleRtSigreturnSystemCall();
