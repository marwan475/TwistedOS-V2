...
public:
    ...
    bool                      GetInterpreterPath(uint64_t PhysicalAddress, uint64_t ImageSize, const ELFHeader& Header, char* InterpreterPathBuffer, uint64_t InterpreterPathBufferSize) const;
